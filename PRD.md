...
| `2026-04-22` | Phase 22 visible brand decision: productName, HTML title, app bundle id, and installer metadata updated to "Ralph". Internal identifiers (npm package name, preload API names `knuthflow.*`, database filename, userData paths) retain Knuthflow through Phase 24 for backward compatibility. | Visible Ralph branding shippable now without breaking existing workspaces, sessions, tests, or data. Full internal rename deferred to Phase 24 with a compatibility layer. | Engineering |
| `2026-04-22` | Resolved Q-001: App visible name is "Ralph"; macOS bundle id `com.ralph.app`; installer name "Ralph". | Phase 22 visible brand change ships with Ralph as the visible name. Internal compatibility identifiers preserved through Phase 24. | Engineering |
